...
def assert_layerwise_gpu_connector(gpu_connector: "GPUConnectorInterface"):
    ...
    # First Party
    from lmcache.v1.gpu_connector import gpu_connectors, kpu_connectors
    ...
    valid_connectors = (
        ...
        kpu_connectors.VLLMPagedMemLayerwiseKPUConnector,
        kpu_connectors.VLLMBufferLayerwiseKPUConnector,
        kpu_connectors.SGLangLayerwiseKPUConnector,
    )
